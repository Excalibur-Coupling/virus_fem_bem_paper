...
\\
    The boundary element method is a popular numerical algorithm to solve the Poisson-Boltzmann equation for molecular electrostatics. However, this technique is limited to linear equations and piece-wise constant variations of the field parameters. Here, we overcome such limitations by coupling it with a finite element method, implemented using the Bempp-cl and FEniCSx libraries through simple Python interfaces. This results in an efficient, accurate, flexible, and easy-to-use computational tool for model development. 
\end{minipage}
}}
\end{figure}
