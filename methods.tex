...
\end{align}
%
where $\mathbf{r}\in\Omega_1$, and we can obtain $\phi_1$ and $\lambda_1$ from $\phi_2$ and $\lambda_2$ by applying the interface conditions from Eq. \eqref{eq:pbe}.
