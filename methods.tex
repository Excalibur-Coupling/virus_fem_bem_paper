...
Then, the coupling problem can be written as: \textit{Find $ \phi_1 \in H^1(\Omega_1)$ and $\lambda_2 \in H^{-\frac{1}{2}}(\Gamma)$ such that for all $v \in H^1(\Omega_1)$ and $\zeta \in H^{-\frac{1}{2}}(\Gamma)$},
\begin{subequations}
...
\end{align*}
\mscomment{As $I$ is not equal to the identity matrix, we should maybe change the letter we use? I'd usually change it to $M$ but we've also already used that}
