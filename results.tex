...
Table XX shows that finite element grids generated from a surface mesh with 12, 17 and 24 vertices per \AA$^2$, and a quality parameter of 1.1 in TetGen, are within the convergence region ({\it ie.} the observed order of convergence agrees with the theoretical order of the method).\cite{roache1998verification,CooperBardhanBarba2014}
