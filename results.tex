...
\caption{Time-to-solution for arginine with a constant permittivity (left: Preconditioned systems, right: No preconditioner).  %(1) fix title, (2) can we put them in a single plot, (3) 
