This section presents the verification and performance results of the presented FEM-BEM coupling schemes for molecules modelled as cavities with constant and varying permittivity.
...
This data set consists of three families of structures: DNA-drug complexes, different versions of the barnase-barstar complex, and RNA-peptide complexes. Following the problem setting for these data sets, we use $\epsilon_1=1$, $\epsilon_2=80$ and an inverse of the Debye length of $\kappa=0.10265\,\text{\AA}^{-1}$.
