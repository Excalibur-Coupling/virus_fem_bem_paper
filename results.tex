...
\begin{figure}
  \centering
  \includegraphics[width=0.45\linewidth]{DolfinX_Sphere_const_coeff_error_1e-4.png}
  \includegraphics[width=0.45\linewidth]{DolfinX_Sphere_const_coeff_error.png}
  \caption{Error for the Kirkwood sphere.  \textcolor{blue}{(LEFT: $tol = 10^{-4}$, RIGHT: $tol = 10^{-5}$)}}
...
\begin{figure}
\centering
   \includegraphics[width=0.45\linewidth]{DolfinX_Arginine2_const_coeff_error_1e-4.png}
...
\caption{Solvation energy for arginine with a constant permittivity.  \textcolor{blue}{(LEFT: $tol = 10^{-4}$, RIGHT: $tol = 10^{-5}$)}}
\label{fig:arg_constant_energy}
\end{figure}

\begin{figure}
\centering
   \includegraphics[width=0.45\linewidth]{DolfinX_Arginine2_const_coeff_iter_1e-4.png}
...
%  \includegraphics[width=0.45\linewidth]{DolfinX_Arginine2_const_coeff_setup_time.png}
  \includegraphics[width=0.45\linewidth]{DolfinX_Arginine2_const_coeff_total_time_1e-4.png}
...
%  \includegraphics[width=0.45\linewidth]{DolfinX_Arginine_const_coeff_total_time_11.png}
  ...
  \caption{Iteration count (left) and time-to-solution (right) for arginine with a constant permittivity.  \textcolor{blue}{(UP: $tol = 10^{-4}$, DOWN: $tol = 10^{-5}$)}
}
...
\hline
\end{tabular}
\caption{Solvation energy of arginine with a Gaussian-like permittivity, computed using the FEM-BEM approach and APBS. The mesh density for FEM-BEM corresponds to the vertex density of the surface mesh used to generate the volumetric mesh. \textcolor{blue}{(MIDDLE: $tol = 10^{-4}$, DOWN: $tol = 10^{-5}$)}}
...
\hline
 ...
 1lyz  & 56 114 & 18 606 &  -599.310 & 1073 & 336 & 1 350  & 1.26 & 1 686   \\
 ...
 \hline
\end{tabular}}
\caption{Results for larger structures with a variable permittivity. \textcolor{blue}{(UP: $tol = 10^{-4}$, DOWN: $tol = 10^{-5}$)}
}
