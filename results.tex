...
\begin{figure}
\centering
\includegraphics[width=0.45\linewidth]{BEM_BEM_Arginine_const_coeff_time.png}
\includegraphics[width=0.45\linewidth]{FEM_BEM_Arginine_const_coeff_time.png}
\includegraphics[width=0.45\linewidth]{Hybrid_FEM_BEM_Arginine_const_coeff_time.png}
\caption{Time-to-solution for arginine with a constant permittivity. (1) fix title, (2) can we put them in a single plot, (3) maybe we could also add a "error" wrt extrapolation, or a plot with energy for each mesh?}
